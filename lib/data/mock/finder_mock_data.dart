...
class FinderMockData {
  ...
  static final manuals = <ManualItem>[
    ...
    ManualItem(
      id: 'm-008',
      title: '海尔 变频冰箱 BCD-470',
      brand: 'Haier',
      model: 'BCD-470',
      room: '厨房',
      updatedAt: DateTime(2026, 2, 5),
      tags: [tags['kitchen']!, tags['warranty']!],
      coverGradient: 'green',
      underWarranty: true,
    ),
    ManualItem(
      id: 'm-009',
      title: 'LG OLED C3 用户指南',
      brand: 'LG',
      model: 'OLED C3',
      room: '客厅',
