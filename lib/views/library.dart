...
class _LibraryPageState extends State<LibraryPage> {
                          ...
                          child: Center(
                            child: Column(
                              ...
                              children: [
                                ...
                                SizedBox(height: 12),
                                Text('暂无说明书', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w500)),
                                SizedBox(height: 4),
                                Text('点击右下角 Scan 按钮添加', style: TextStyle(color: Colors.grey)),
                              ],
                            ),
                          ),
                        )
  ...
  Future<(String, String, String)?> _showEditDialog(
...
class _UploadBundleDetailSheet extends StatefulWidget {
  ...
  @override
  State<_UploadBundleDetailSheet> createState() =>
      _UploadBundleDetailSheetState();
}
